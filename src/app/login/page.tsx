        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
            ...
            <p className="text-white/80 text-sm italic leading-relaxed mb-4">
              &ldquo;Com o Sippe, minha receita de comunidade cresceu 340% em 6 meses. É incrível.&rdquo;
            </p>
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="text-white text-sm font-semibold">Rafael Torres</p>
                <p className="text-white/40 text-xs">Empreendedor Digital · 45.2k membros</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-[400px]">
            ...
            <div className="relative flex items-center gap-3 mb-6">
              ...
              <span className="text-xs text-[#a3a3a3] font-medium">ou entre com e-mail</span>
              <div className="flex-1 h-px bg-[#e5e5e5]" />
            </div>
